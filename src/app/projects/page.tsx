      ...
      <section id="projects" className="snap-center">
        ...
        <div className="sticky top-0 p-5 flex flex-wrap items-start justify-between max-w-4xl mx-auto xl:items-center">
          {projects?.map((project) => (
            <div className="block mb-20 bg-white border border-gray-200 rounded-lg shadow-sm hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
              <div key={project._id}>
                <h2>{project.title}</h2>
